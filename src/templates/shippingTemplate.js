function shippingTemplate({ name, trackingNumber, orderId }) {
    return `
    <!DOCTYPE html>
<html>
          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:8px; overflow:hidden;">
            ...
            <tr>
              <td style="background:#40513B; padding:20px; text-align:center; color:white;">
                <h1 style="margin:0; font-size:24px;">Shipping Notification</h1>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:30px; color:#333;">
                ...
                <p style="line-height:1.6;">
                 Your order ${orderId} has been shipped! Your tracking number is ${trackingNumber}. You can track your package through our website or the carrier's tracking page.
                </p>
...
module.exports = shippingTemplate;