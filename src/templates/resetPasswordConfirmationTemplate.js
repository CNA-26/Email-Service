function resetPasswordConfirmationTemplate({ name, newPassword }) {
    return `
    <!DOCTYPE html>
<html>
          ...
          <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:8px; overflow:hidden;">
            ...
            <tr>
              <td style="background:#40513B; padding:20px; text-align:center; color:white;">
                <h1 style="margin:0; font-size:24px;">Password reset successfully</h1>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:30px; color:#333;">
                ...
                <p style="line-height:1.6;">
                 We have generated a new password for your account: ${newPassword}
                </p>

                </p>
                <p>Please be sure to change the password as soon as possible.</p>
